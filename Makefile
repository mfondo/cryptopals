...
CHAR_FREQUENCY_TEST_SOURCES=CharFrequency.cpp CharFrequencyTest.cpp
CHAR_FREQUENCY_TEST_OBJECTS=$(CHAR_FREQUENCY_TEST_SOURCES:.cpp=.o)
CHAR_FREQUENCY_TEST_EXECUTABLE=CharFrequencyTest.out
charFrequencyTest: $(CHAR_FREQUENCY_TEST_SOURCES) $(CHAR_FREQUENCY_TEST_EXECUTABLE)
$(CHAR_FREQUENCY_TEST_EXECUTABLE): $(CHAR_FREQUENCY_TEST_OBJECTS)
	$(CC) $(LDFLAGS) $(CHAR_FREQUENCY_TEST_OBJECTS) -o $@
	
CHALLENGE_1_3_SOURCES=Xor.cpp Hex.cpp CharFrequency.cpp Challenge_1_3.cpp
CHALLENGE_1_3_OBJECTS=$(CHALLENGE_1_3_SOURCES:.cpp=.o)
CHALLENGE_1_3_EXECUTABLE=Challenge_1_3.out
challenge_1_3: $(CHALLENGE_1_3_SOURCES) $(CHALLENGE_1_3_EXECUTABLE)
$(CHALLENGE_1_3_EXECUTABLE): $(CHALLENGE_1_3_OBJECTS)
	$(CC) $(LDFLAGS) $(CHALLENGE_1_3_OBJECTS) -o $@		

CHALLENGE_1_4_SOURCES=Xor.cpp Hex.cpp CharFrequency.cpp Challenge_1_4.cpp
CHALLENGE_1_4_OBJECTS=$(CHALLENGE_1_4_SOURCES:.cpp=.o)
CHALLENGE_1_4_EXECUTABLE=Challenge_1_4.out
challenge_1_4: $(CHALLENGE_1_4_SOURCES) $(CHALLENGE_1_4_EXECUTABLE)
$(CHALLENGE_1_4_EXECUTABLE): $(CHALLENGE_1_4_OBJECTS)
	$(CC) $(LDFLAGS) $(CHALLENGE_1_4_OBJECTS) -o $@		
